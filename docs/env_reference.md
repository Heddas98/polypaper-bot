...
> **`.env.example` coverage:** 126 / 298 runtime keys are documented in `.env.example`.
...
| `ADAPTIVE_MAKER_ENABLED` | `'true'` | ✅ | ✅ | `core/engine_signals.py:1774` |
| `ADAPTIVE_MAKER_IMPROVE_TICKS` | `'1'` | ✅ |  | `core/engine_signals.py:1815` |
| `ADAPTIVE_MAKER_MAX_SIGNAL` | `'0.45'` | ✅ |  | `core/engine_signals.py:1804` |
| `ADAPTIVE_MAKER_MIN_MINS` | `'2.0'` | ✅ |  | `core/engine_signals.py:1803` |
| `ADAPTIVE_MAX_THRESHOLD` | `'0.85'` |  |  | `core/ai_brain.py:771`, `core/auto_optimizer.py:786` |
...
| `ADMIN_CHAT_ID` | `None` |  |  | `core/engine.py:731`, `core/engine.py:1042`, `core/engine_settlement.py:363` (+7 more) |
| `ADMIN_TELEGRAM_ID` | `'0'` |  | ✅ | `core/auto_optimizer.py:635`, `core/engine.py:731`, `core/engine.py:1042` (+16 more) |
...
| `AI_AUTO_CONFIDENCE` | `'0.70'` |  | ✅ | `core/ai_brain.py:387`, `core/ai_brain.py:2040` |
| `AI_BRAIN_CYCLE` | `'3600'` |  | ✅ | `core/ai_brain.py:99` |
| `AI_MIN_TRADES` | `'15'` |  | ✅ | `core/ai_brain.py:101` |
| `AI_STRATEGY_SUGGEST_INTERVAL` | `'14400'` |  |  | `core/strategy_suggester.py:25` |
| `AI_TWO_AGENT_MODE` | `'true'` |  | ✅ | `core/ai_brain.py:333` |
...
| `ALLOWANCE_PREFLIGHT_ENABLED` | `'false'` |  |  | `core/engine.py:585` |
| `ALLOWED_ZONES` | `'(tumu)'` |  | ✅ | `core/ai_brain.py:769`, `core/engine_signals.py:68` |
| `ANTHROPIC_API_KEY` | `''` |  | ✅ | `core/ai_brain.py:35`, `core/intent_parser.py:47` |
| `ARCHIVE_DIR` | `<expr>` |  |  | `backtest/archive_reader.py:111` |
| `AUTO_PROMOTE_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1166` |
| `AUTO_PROMOTE_FIRST_SEC` | `'1200'` |  |  | `telegram_bot/bot.py:1168` |
| `AUTO_PROMOTE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1167` |
| `AUTO_REDEEM_ENABLED` | `'false'` |  | ✅ | `telegram_bot/bot.py:1116`, `telegram_bot/handlers/main_dashboard.py:330`, `telegram_bot/jobs/auto_redeem_job.py:37` |
| `AUTO_REDEEM_FIRST_SEC` | `'120'` |  | ✅ | `telegram_bot/bot.py:1121` |
| `AUTO_REDEEM_INTERVAL_SEC` | `'300'` |  | ✅ | `telegram_bot/bot.py:1120` |
...
| `BAYESIAN_UPDATER_ENABLED` | `'false'` |  | ✅ | `core/ai_brain.py:760`, `core/signal_fusion.py:552` |
...
| `BRIER_ALARM_ENABLED` | `'true'` | ✅ |  | `core/engine_signals.py:1378` |
| `BRIER_GAP_MAX` | `'0.30'` |  | ✅ | `core/engine_signals.py:78` |
| `CALENDAR_MULT_ENABLED` | `'false'` |  | ✅ | `core/ai_brain.py:762`, `core/signal_fusion.py:539` |
| `CANARY_SIZE_MULT` | `'1.0'` |  | ✅ | `core/engine_signals.py:1674` |
...
| `CLASSIC_RESPECT_FEE_TAIL` | `'false'` | ✅ |  | `core/engine_signals.py:1890` |
| `CLASSIC_RESPECT_TOKEN_CAP` | `'false'` | ✅ |  | `core/engine_signals.py:1959` |
| `CLASSIC_RESPECT_UNSELLABLE` | `'false'` | ✅ | ✅ | `core/engine_signals.py:1400` |
| `CLASSIC_RESPECT_ZONES` | `'false'` | ✅ | ✅ | `core/engine_signals.py:996` |
| `CLASSIC_TAKER_LIMIT_CEIL` | `'0.99'` | ✅ |  | `core/engine_signals.py:1855` |
...
| `CONFLUENCE_K` | `'3'` |  | ✅ | `core/ai_brain.py:765`, `core/signal_fusion.py:557` |
| `CONFLUENCE_MODE` | `'true'` |  | ✅ | `core/signal_fusion.py:556` |
| `CONFLUENCE_PENALTY` | `'0.3'` |  | ✅ | `core/ai_brain.py:766`, `core/signal_fusion.py:560` |
| `CONFLUENCE_SIGNAL_THRESHOLD` | `'0.05'` |  |  | `core/signal_fusion.py:558` |
| `CONVICTION_ENABLED` | `'true'` |  |  | `core/engine_signals.py:1562` |
| `CONVICTION_MIN` | `'0.3'` | ✅ | ✅ | `core/engine_signals.py:1578` |
| `DB_ARCHIVE_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1195` |
| `DB_ARCHIVE_FIRST_SEC` | `'600'` |  |  | `telegram_bot/bot.py:1197` |
| `DB_ARCHIVE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1196` |
| `DB_RETENTION_FIRST_SEC` | `'900'` |  | ✅ | `telegram_bot/bot.py:1049` |
| `DB_RETENTION_INTERVAL_SEC` | `'86400'` |  | ✅ | `telegram_bot/bot.py:1048` |
| `DB_RETENTION_MODE` | `'report'` |  | ✅ | `telegram_bot/jobs/db_retention_job.py:241` |
| `DB_RETENTION_NOTIFY` | `'1'` |  | ✅ | `telegram_bot/jobs/db_retention_job.py:364` |
| `DB_RETENTION_VACUUM_ENABLED` | `'1'` |  | ✅ | `telegram_bot/jobs/db_retention_job.py:329` |
| `DB_SNAPSHOT_FIRST_SEC` | `'300'` |  |  | `telegram_bot/bot.py:1018` |
| `DB_SNAPSHOT_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1017` |
...
| `EDGE_ZONE_5065_MIN` | `'0.45'` | ✅ | ✅ | `core/engine_signals.py:1336` |
...
| `ENGINE_STALL_ENABLED` | `'1'` |  |  | `core/engine.py:705` |
| `ENGINE_STALL_TIMEOUT` | `'90'` |  |  | `core/engine.py:708` |
...
| `EV_THRESHOLD_ENABLED` | `'true'` |  | ✅ | `calibration/ev_threshold.py:38`, `core/engine_signals.py:1614` |
| `EXPERIMENT_ENABLED` | `'true'` |  | ✅ | `core/engine.py:271`, `core/experiment_runner.py:27` |
| `EXPERIMENT_MAX_PARAMS` | `'5'` |  | ✅ | `core/experiment_runner.py:28` |
| `FEE_GATE_ENABLED` | `'true'` | ✅ |  | `core/engine_signals.py:1362` |
...
| `HEARTBEAT_ENABLED` | `'false'` |  |  | `core/engine.py:616` |
| `HEARTBEAT_INTERVAL_SEC` | `'600'` |  |  | `telegram_bot/bot.py:1013` |
...
| `LIFECYCLE_MIN_OVERRIDE` | `'false'` |  |  | `core/engine_signals.py:893` |
...
| `MAX_WS_TOKENS` | `'200'` |  |  | `data/websocket_client.py:156` |
...
| `MIN_COMPOSITE` | `'0.30'` | ✅ | ✅ | `core/ai_brain.py:750`, `core/engine_signals.py:897`, `core/signal_fusion.py:120` |
| `MIN_EDGE_OVER_FEE` | `'2.0'` | ✅ |  | `core/engine_signals.py:1364` |
| `MIN_ORDER_SHARES` | `'1.0'` |  | ✅ | `core/engine.py:1392`, `core/engine_signals.py:65`, `telegram_bot/handlers/diagnose_handler.py:172` (+1 more) |
...
| `MODE_DEFAULT` | `'paper'` |  |  | `telegram_bot/handlers/main_dashboard.py:329` |
...
| `OB_CACHE_TTL` | `'2.0'` |  |  | `core/engine.py:168` |
| `OB_RECORD_MARKETS` | `'8'` |  |  | `data/market_scanner.py:44` |
| `OB_SIGNAL_DECAY` | `'0.85'` |  | ✅ | `core/signal_fusion.py:408` |
| `OB_SIGNAL_LEVELS` | `'20'` |  | ✅ | `core/signal_fusion.py:407` |
| `OPENROUTER_API_KEY` | `''` |  |  | `core/ai_brain.py:119` |
| `OPTIMISM_TAX_ENABLED` | `'true'` | ✅ | ✅ | `core/engine_signals.py:1832` |
| `OPTIMISM_TAX_TICKS` | `'1'` | ✅ | ✅ | `core/engine_signals.py:1833` |
| `PATTERN_DISCOVERY_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1177` |
| `PATTERN_DISCOVERY_FIRST_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1184` |
| `PATTERN_DISCOVERY_INTERVAL_SEC` | `'604800'` |  |  | `telegram_bot/bot.py:1181` |
| `PNL_DIVERGENCE_ALERT_PCT` | `'5.0'` | ✅ |  | `telegram_bot/handlers/live_guards_handler.py:187`, `telegram_bot/jobs/pnl_divergence_job.py:57` |
| `PNL_DIVERGENCE_ENABLED` | `'true'` | ✅ |  | `telegram_bot/bot.py:1138`, `telegram_bot/handlers/live_guards_handler.py:185`, `telegram_bot/jobs/pnl_divergence_job.py:47` |
| `PNL_DIVERGENCE_FIRST_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1143` |
| `PNL_DIVERGENCE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1140` |
...
| `POLYGON_WALLET` | `''` |  | ✅ | `core/engine.py:640`, `core/live_trader.py:1177`, `core/live_trader.py:208` (+7 more) |
...
| `PORTFOLIO_REFRESH_ENABLED` | `'true'` |  | ✅ | `telegram_bot/bot.py:1101`, `telegram_bot/jobs/polymarket_portfolio_job.py:40` |
| `PORTFOLIO_REFRESH_FIRST_SEC` | `'30'` |  | ✅ | `telegram_bot/bot.py:1103` |
| `PORTFOLIO_REFRESH_SEC` | `'60'` |  | ✅ | `telegram_bot/bot.py:1102` |
| `PRICE_ALERT_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1157` |
| `PRICE_ALERT_INTERVAL_SEC` | `'30'` |  |  | `telegram_bot/bot.py:1158` |
| `PRICE_SANITY_HI` | `'0.99'` |  |  | `core/engine_signals.py:965` |
| `PRICE_SANITY_LO` | `'0.02'` |  |  | `core/engine_signals.py:964` |
...
| `REALITY_GAP_ALERT_PCT` | `'10.0'` |  |  | `telegram_bot/handlers/backtest_lab.py:144`, `telegram_bot/handlers/backtest_lab.py:1352`, `telegram_bot/handlers/backtest_lab.py:1246` (+1 more) |
| `REALITY_GAP_ENABLED` | `'true'` |  |  | `telegram_bot/bot.py:1076`, `telegram_bot/handlers/reality_gap_handler.py:39` |
| `REALITY_GAP_MULT` | `'0.66'` |  |  | `telegram_bot/handlers/backtest_lab.py:110`, `telegram_bot/handlers/backtest_lab.py:1350`, `telegram_bot/handlers/backtest_lab.py:1291` (+1 more) |
| `REALITY_GAP_TIME_HHMM` | `'03:00'` |  |  | `telegram_bot/bot.py:1079` |
| `REALITY_GAP_WINDOW_H` | `'168'` |  |  | `telegram_bot/handlers/backtest_lab.py:1354`, `telegram_bot/handlers/reality_gap_handler.py:38` |
...
| `REV_BYPASS_SIGNAL_GATES` | `'true'` |  | ✅ | `core/engine_signals.py:181` |
| `REV_ENTRY_PRICE_MAX` | `'0.60'` |  | ✅ | `core/engine_signals.py:983` |
| `REV_ENTRY_PRICE_MIN` | `'0.40'` |  | ✅ | `core/engine_signals.py:982` |
...
| `SCAN_INTERVAL_S` | `'5'` |  |  | `data/market_scanner.py:35` |
| `SENTRY_DSN` | `''` |  | ✅ | `core/observability/sentry_tx.py:54` |
| `SHADOW_COMPARE_FIRST_SEC` | `'1800'` |  |  | `telegram_bot/bot.py:1059` |
| `SHADOW_COMPARE_INTERVAL_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1058` |
...
| `SHADOW_REPORT_FIRST_SEC` | `'60'` |  |  | `telegram_bot/bot.py:1004` |
| `SHADOW_REPORT_INTERVAL_SEC` | `'1800'` |  |  | `telegram_bot/bot.py:1003` |
| `SHADOW_WATCHED_TYPES` | `None` |  |  | `telegram_bot/jobs/shadow_report_job.py:73` |
| `SIGNAL_DRIFT_WINDOW` | `'100'` |  |  | `core/regime.py:138` |
| `SIGNAL_W_EMA` | `'0.25'` |  |  | `core/ai_brain.py:753`, `core/signal_fusion.py:61` |
| `SIGNAL_W_MOMENTUM` | `'0.30'` |  |  | `core/ai_brain.py:754`, `core/signal_fusion.py:62` |
| `SIGNAL_W_ODDS` | `'0.05'` |  |  | `core/ai_brain.py:752`, `core/signal_fusion.py:60` |
| `SIGNAL_W_ORDERBOOK` | `'0.20'` |  |  | `core/ai_brain.py:756`, `core/signal_fusion.py:65` |
| `SIGNAL_W_TIME` | `'0.10'` |  |  | `core/ai_brain.py:755`, `core/signal_fusion.py:64` |
| `SIGNAL_W_VOLATILITY` | `'0.00'` |  |  | `core/signal_fusion.py:63` |
| `SIGNAL_W_WHALE` | `'0.00'` |  |  | `core/signal_fusion.py:66` |
| `SLIPPAGE_GATE_ENABLED` | `'true'` | ✅ | ✅ | `core/engine_signals.py:1323` |
| `SMART_EXIT_ENABLED` | `'true'` |  | ✅ | `core/ai_brain.py:768`, `core/engine_monitor.py:42` |
| `SMART_EXIT_GRACE_SEC` | `'60'` |  | ✅ | `core/engine_monitor.py:54` |
| `STOP_LOSS_DELTA` | `'0.12'` |  | ✅ | `core/engine_monitor.py:50` |
| `STRATEGY_SUGGESTER_ENABLED` | `'false'` |  |  | `telegram_bot/bot.py:1210` |
| `STRATS_ZERO_WARN_MINUTES` | `'10'` |  |  | `core/engine.py:1028` |
...
| `SURFACE_2D_ENABLED` | `'true'` |  | ✅ | `calibration/surface_2d.py:49`, `core/engine.py:283`, `core/engine_signals.py:1208` |
...
| `TECHNICAL_INDICATORS_ENABLED` | `'false'` |  | ✅ | `core/ai_brain.py:761`, `core/signal_fusion.py:564` |
| `THOMPSON_TOP_PCT` | `'0.40'` |  |  | `core/strategy_selector.py:27` |
| `TRADE_MEMORY_BOOST_MAX` | `'0.15'` |  | ✅ | `core/trade_memory.py:43` |
| `TRADE_MEMORY_ENABLED` | `'true'` |  | ✅ | `core/engine.py:247`, `core/trade_memory.py:40` |
...
| `TRADE_REASONING_LOG` | `'true'` | ✅ |  | `core/engine_signals.py:2003` |
| `UMA_SETTLEMENT_BUFFER_MIN` | `<expr>` |  |  | `core/uma_dispute.py:65` |
| `UNSELLABLE_CHECK_ENABLED` | `'true'` | ✅ |  | `core/engine_signals.py:1403` |
| `UNSELLABLE_CLOSE_WARNING_MINS` | `'2.0'` |  |  | `core/risk_manager.py:620` |
| `UNSELLABLE_MIN_ENTRY_DEPTH` | `'5.0'` |  |  | `core/risk_manager.py:619` |
| `WAL_CHECKPOINT_FIRST_SEC` | `'1200'` |  |  | `telegram_bot/bot.py:1034` |
| `WAL_CHECKPOINT_INTERVAL_HOURS` | `'6'` |  |  | `telegram_bot/bot.py:1031` |
| `WARMUP_MAX_WAIT` | `'120'` |  |  | `core/engine.py:925` |
...
| `WHALE_SIGNAL_ENABLED` | `'false'` |  | ✅ | `core/ai_brain.py:759`, `core/signal_fusion.py:549` |
| `WHALE_SIGNAL_WEIGHT` | `None` |  | ✅ | `core/signal_fusion.py:127` |
| `WHIPSAW_BAND_HI` | `'0.60'` |  |  | `core/engine_signals.py:457` |
| `WHIPSAW_BAND_LO` | `'0.40'` |  |  | `core/engine_signals.py:456` |
| `WS_FLUSH_INTERVAL_S` | `'1.0'` |  |  | `data/websocket_client.py:86` |
| `WS_FLUSH_MAX_ROWS` | `'2000'` |  |  | `data/websocket_client.py:87` |
| `WS_FORCE_RECONNECT_SEC` | `'300'` |  |  | `data/websocket_client.py:276` |
| `WS_STALE_MIN_THRESHOLD` | `'0.70'` | ✅ |  | `core/engine_signals.py:448` |
| `WS_STALE_SEC` | `'60'` |  |  | `data/websocket_client.py:774` |
| `WS_STALE_THRESHOLD` | `'60.0'` | ✅ |  | `core/engine.py:1168`, `data/websocket_client.py:774`, `telegram_bot/handlers/diagnose_handler.py:173` (+2 more) |
