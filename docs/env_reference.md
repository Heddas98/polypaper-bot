...
| `ADMIN_CHAT_ID` | `None` |  |  | `core/engine.py:617`, `core/engine.py:875`, `core/engine_settlement.py:196` (+6 more) |
| `ADMIN_TELEGRAM_ID` | `'0'` |  | ✅ | `core/auto_optimizer.py:581`, `core/engine.py:617`, `core/engine.py:875` (+14 more) |
...
| `MIN_ORDER_SHARES` | `'1.0'` |  | ✅ | `core/engine.py:1197`, `core/engine_signals.py:52`, `telegram_bot/handlers/diagnose_handler.py:171` (+1 more) |
...
| `WS_STALE_THRESHOLD` | `'60.0'` | ✅ |  | `core/engine.py:993`, `data/websocket_client.py:404`, `telegram_bot/handlers/diagnose_handler.py:172` (+2 more) |
