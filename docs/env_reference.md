...
> **`.env.example` coverage:** 125 / 294 runtime keys are documented in `.env.example`.
...
| `AUTO_PROMOTE_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1189` |
| `AUTO_PROMOTE_FIRST_SEC` | `'1200'` |  |  | `telegram_bot/bot.py:1191` |
| `AUTO_PROMOTE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1190` |
| `AUTO_REDEEM_ENABLED` | `'false'` |  | ✅ | `telegram_bot/bot.py:1139`, `telegram_bot/handlers/main_dashboard.py:329`, `telegram_bot/jobs/auto_redeem_job.py:37` |
| `AUTO_REDEEM_FIRST_SEC` | `'120'` |  | ✅ | `telegram_bot/bot.py:1144` |
| `AUTO_REDEEM_INTERVAL_SEC` | `'300'` |  | ✅ | `telegram_bot/bot.py:1143` |
...
| `DB_ARCHIVE_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1218` |
| `DB_ARCHIVE_FIRST_SEC` | `'600'` |  |  | `telegram_bot/bot.py:1220` |
| `DB_ARCHIVE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1219` |
| `DB_RETENTION_FIRST_SEC` | `'900'` |  | ✅ | `telegram_bot/bot.py:1072` |
| `DB_RETENTION_INTERVAL_SEC` | `'86400'` |  | ✅ | `telegram_bot/bot.py:1071` |
...
| `DB_SNAPSHOT_FIRST_SEC` | `'300'` |  |  | `telegram_bot/bot.py:1041` |
| `DB_SNAPSHOT_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1040` |
...
| `HEARTBEAT_INTERVAL_SEC` | `'600'` |  |  | `telegram_bot/bot.py:1036` |
...
| `MIN_COMPOSITE` | `'0.30'` | ✅ | ✅ | `core/ai_brain.py:750`, `core/engine_signals.py:789`, `core/signal_fusion.py:120` |
...
| `PATTERN_DISCOVERY_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1200` |
| `PATTERN_DISCOVERY_FIRST_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1207` |
| `PATTERN_DISCOVERY_INTERVAL_SEC` | `'604800'` |  |  | `telegram_bot/bot.py:1204` |
| `PNL_DIVERGENCE_ALERT_PCT` | `'5.0'` | ✅ |  | `telegram_bot/handlers/live_guards_handler.py:187`, `telegram_bot/jobs/pnl_divergence_job.py:57` |
| `PNL_DIVERGENCE_ENABLED` | `'true'` | ✅ |  | `telegram_bot/bot.py:1161`, `telegram_bot/handlers/live_guards_handler.py:185`, `telegram_bot/jobs/pnl_divergence_job.py:47` |
| `PNL_DIVERGENCE_FIRST_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1166` |
| `PNL_DIVERGENCE_INTERVAL_SEC` | `'86400'` |  |  | `telegram_bot/bot.py:1163` |
...
| `PORTFOLIO_REFRESH_ENABLED` | `'true'` |  | ✅ | `telegram_bot/bot.py:1124`, `telegram_bot/jobs/polymarket_portfolio_job.py:40` |
| `PORTFOLIO_REFRESH_FIRST_SEC` | `'30'` |  | ✅ | `telegram_bot/bot.py:1126` |
| `PORTFOLIO_REFRESH_SEC` | `'60'` |  | ✅ | `telegram_bot/bot.py:1125` |
| `PRICE_ALERT_ENABLED` | `'1'` |  |  | `telegram_bot/bot.py:1180` |
| `PRICE_ALERT_INTERVAL_SEC` | `'30'` |  |  | `telegram_bot/bot.py:1181` |
...
| `REALITY_GAP_ALERT_PCT` | `'10.0'` |  |  | `telegram_bot/handlers/backtest_lab.py:144`, `telegram_bot/handlers/backtest_lab.py:1212`, `telegram_bot/handlers/backtest_lab.py:1106` (+1 more) |
| `REALITY_GAP_ENABLED` | `'true'` |  |  | `telegram_bot/bot.py:1099`, `telegram_bot/handlers/reality_gap_handler.py:39` |
| `REALITY_GAP_MULT` | `'0.66'` |  |  | `telegram_bot/handlers/backtest_lab.py:110`, `telegram_bot/handlers/backtest_lab.py:1210`, `telegram_bot/handlers/backtest_lab.py:1151` (+1 more) |
| `REALITY_GAP_TIME_HHMM` | `'03:00'` |  |  | `telegram_bot/bot.py:1102` |
| `REALITY_GAP_WINDOW_H` | `'168'` |  |  | `telegram_bot/handlers/backtest_lab.py:1214`, `telegram_bot/handlers/reality_gap_handler.py:38` |
...
| `SHADOW_COMPARE_FIRST_SEC` | `'1800'` |  |  | `telegram_bot/bot.py:1082` |
| `SHADOW_COMPARE_INTERVAL_SEC` | `'3600'` |  |  | `telegram_bot/bot.py:1081` |
...
| `SHADOW_REPORT_FIRST_SEC` | `'60'` |  |  | `telegram_bot/bot.py:1027` |
| `SHADOW_REPORT_INTERVAL_SEC` | `'1800'` |  |  | `telegram_bot/bot.py:1026` |
...
| `STRATEGY_SUGGESTER_ENABLED` | `'false'` |  |  | `telegram_bot/bot.py:1233` |
...
| `WAL_CHECKPOINT_FIRST_SEC` | `'1200'` |  |  | `telegram_bot/bot.py:1057` |
| `WAL_CHECKPOINT_INTERVAL_HOURS` | `'6'` |  |  | `telegram_bot/bot.py:1054` |
