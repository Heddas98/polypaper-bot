...
class FeeCalculatorV3:
    ...
    def calculate_fee(
        self, price: float, amount_usd: float, spread: Optional[float] = None
    ) -> float:
    ...
    def calculate_ev(
        self, price: float, win_prob: float, amount: float = 1.0, spread: Optional[float] = None
    ) -> float:
