...
async def _build_main_dashboard_text_kb(
    ...
    text = (
        ...
        "📋 <b>PAPER MODE</b> — Simülasyon / geçmiş\n"
        "  <i>Geçmiş paper verisi + LAB backtest. Risk yok.\n"
        "  Otomatik trade VARSAYILAN kapalı; LAB → Candle/Martingale →\n"
        "  🤖 Paper Auto-Trade ile rev↑ stratejisi açılabilir (opt-in).</i>\n"
