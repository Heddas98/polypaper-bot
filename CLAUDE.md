...
> Son güncelleme: 2026-05-19 (5m resolution=Chainlink + RTDS feed bağlandı + flip edge soruşturması · market likidite filtresi).
...
- **⚠️ Veri uyarısı (2026-05-19, araştırma açık)**: `executions` tablosu **251 trade / -$54.28** — memory/`main_dashboard.py:186` yorumundaki "1417 trade +$355" ile ÇELİŞİYOR. `trade_log` SETTLEMENT 54 kayıt/-$28.52. Tüm büyük-örneklemli stratejiler net negatif. Paper PnL tutarsızlığı ayrı task'a açıldı — "+$355" doğrulanana kadar **ŞÜPHELİ**, `PAPER_BUDGET_DISPLAY=10386` da bundan türüyor.
