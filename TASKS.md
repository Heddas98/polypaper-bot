...
- [ ] **T4.7-C** *(yeni 2026-04-24)* — `config/settings.py` fill heuristic defaults update: `FILL_SPREAD_COST=0.005 → 0.023`, `FILL_IMPACT_SCALE=0.01 → 0.025`, `FILL_LATENCY_DRIFT_BPS_PER_MS=0.08 → 0.04`. Kanıt T4.6-B sweep (delta -33.68%). Bu değişiklikle sweep self-consistent (PASS) olur. Pre-change yedek: mevcut sweep JSON kalıcı.
